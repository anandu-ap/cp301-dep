...
const LeavePage = () => {
  ...
  useEffect(() => {
    ...
    .then((data)=> {
      ...
      if((data.hod_status === "Sanctioned" && data.cancel === 0) || (data.dean_registrar_status === "Sanctioned" && data.cancel === 0)){
      ...
      <div className="singleContainer">
        ...
        <div className="bottom">
          <div className="left">
            ...
            {
              (isWithdrawButton) && <button style={{"background-color":"blue"}} className="del" onClick={handleWithdraw}>WITHDRAW</button>
            }
            {
              (isCancelButton) && <button style={{"background-color":"orange"}} className="del" onClick={handleCancel}>CANCEL</button>
            }
            </div>
          </div>
        </div>
